...
namespace JiaJiao.DAL
{
	...
	public partial class ErrorLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "ErrorLog"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from ErrorLog");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ErrorLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ErrorTime,ErrorMessage ");
			strSql.Append(" FROM ErrorLog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,ErrorTime,ErrorMessage ");
			strSql.Append(" FROM ErrorLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ErrorLog T ");
