<%@ Page Title="Class" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="JiaJiao.Web.Class.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Day" HeaderText="星期" SortExpression="Day" ItemStyle-HorizontalAlign="Center" />
