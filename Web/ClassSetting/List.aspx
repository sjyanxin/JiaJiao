<%@ Page Title="ClassSetting" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="JiaJiao.Web.ClassSetting.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TeacherName" HeaderText="老师" SortExpression="TeacherId"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Day" HeaderText="时间" SortExpression="DayId" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Total" HeaderText="开班人数" SortExpression="Total" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Count" HeaderText="报名人数" SortExpression="Count" ItemStyle-HorizontalAlign="Center" />
