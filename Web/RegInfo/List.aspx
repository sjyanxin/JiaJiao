<%@ Page Title="RegInfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="JiaJiao.Web.RegInfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="DayId" HeaderText="DayId" SortExpression="DayId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="StuId" HeaderText="StuId" SortExpression="StuId" ItemStyle-HorizontalAlign="Center"  /> 
