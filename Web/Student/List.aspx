<%@ Page Title="Student" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="JiaJiao.Web.Student.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        RowStyle-HorizontalAlign="Center" OnRowCreated="gridView_OnRowCreated" OnSelectedIndexChanged="gridView_SelectedIndexChanged">
        <Columns>
            ...
            <asp:BoundField DataField="StuEmail" HeaderText="Email" SortExpression="StuEmail"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="StuTel" HeaderText="电话" SortExpression="StuTel" ItemStyle-HorizontalAlign="Center" />
